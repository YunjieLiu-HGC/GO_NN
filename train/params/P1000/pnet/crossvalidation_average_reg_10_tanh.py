...
from model.builders.go_models import build_pnet2
task = 'classification_binary'
selected_genes = 'tcga_prostate_expressed_genes_and_cancer_genes.csv'
data_base = {'id': 'ALL', 'type': 'diabetes',
#data_base = {'id': 'ALL', 'type': 'lc',
             'params': {
    ...
    'params':
        {
            ...
            'model_params': {
                ...
                'dropout': [base_dropout] + [0.0] * (n_hidden_layers + 1),
